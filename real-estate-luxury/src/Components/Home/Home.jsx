            ...
            >
                ...
                <SwiperSlide>
                    <div className='w-full h-full relative   second_slider rounded-lg'>
                        <div className='absolute text-left lg:w-[400px] text-white top-[30%] left-[7%] space-y-3'>
                            <h1 className='font__merriweather font-bold text-2xl lg:text-4xl text-white'>The Azure Haven Estate, Indonesia</h1>
                ...
                <SwiperSlide>
                    <div className='w-full h-full relative   third_slider rounded-lg'>
                        <div className='absolute text-left lg:w-[400px] text-white top-[30%] left-[7%] space-y-3'>
                            <h1 className='font__merriweather font-bold text-2xl lg:text-4xl text-white'>Serenity Cove Island, Indonesia </h1>
